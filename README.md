...
| [ls](The%20ThelsCommand.md) | File enumeration, recon | List hidden files and permissions to spot a misconfigured SUID binary |
...
Found an error, have a better one-liner, or want to suggest a command to cover next? Open an issue or submit a pull request — feedback is always welcome.
